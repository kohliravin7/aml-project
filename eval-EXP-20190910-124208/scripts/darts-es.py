...
class ESWorker(object):
    ...
    def __init__(self, run_dir, experiment_no=0, min_budget=2, max_budget=5, init_channels=16, batch_size=64, split=0.8, dataset=KMNIST, **kwargs):
    ...
    def get_configspace():
        ...
        cs.add_hyperparameters([initial_lr, optimizer, batch_size, n_conv_layers])
