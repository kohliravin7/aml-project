...
def fit(epoch,model,data_loader,criterion,training=True,volatile=False):
    if training:
        phase = 'Training'
        model.train()
    else:
    ...
    print(f'{phase} loss is {objs.avg} and {phase} accuracy is {running_correct}/{len(data_loader.dataset)}{accuracy:{10}.{4}}')
