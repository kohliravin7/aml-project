...
class EnsembleModel(nn.Module):
    ...
    def __init__(self,feature_dim_list, out_size,training=True):
        super().__init__()
        self.fc1 = nn.Linear(feature_dim_list[0],128)
        self.fc2 = nn.Linear(feature_dim_list[0],128)
        self.fc3 = nn.Linear(feature_dim_list[0],128)
        self.fc4 = nn.Linear(128,out_size)
