...
S7HPCDarts= Genotype(normal=[('sep_conv_5x5', 1), ('dil_conv_3x3', 0), ('sep_conv_5x5', 2), ('sep_conv_5x5', 0), ('sep_conv_3x3', 2), ('sep_conv_5x5', 3), ('sep_conv_3x3', 4), ('max_pool_3x3', 1)], normal_concat=range(2, 6), reduce=[('dil_conv_3x3', 1), ('sep_conv_5x5', 0), ('sep_conv_5x5', 1), ('dil_conv_5x5', 2), ('sep_conv_3x3', 1), ('sep_conv_3x3', 2), ('dil_conv_5x5', 2), ('sep_conv_3x3', 4)], reduce_concat=range(2, 6))
MYPCDARTS = Genotype(normal=[('skip_connect', 1), ('avg_pool_3x3', 0), ('skip_connect', 1), ('dil_conv_3x3', 2), ('dil_conv_5x5', 0), ('skip_connect', 3), ('max_pool_3x3', 0), ('skip_connect', 4)], normal_concat=range(2, 6), reduce=[('max_pool_3x3', 1), ('sep_conv_3x3', 0), ('dil_conv_5x5', 1), ('dil_conv_3x3', 2), ('dil_conv_5x5', 1), ('avg_pool_3x3', 3), ('dil_conv_5x5', 0), ('max_pool_3x3', 3)], reduce_concat=range(2, 6))
PCDARTS = MYPCDARTS
